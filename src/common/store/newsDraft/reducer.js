import { ACTION_ADD_NEWS_DRAFT, ACTION_DELETE_NEWS_DRAFT, ACTION_EDIT_NEWS_DRAFT, ACTION_GET_NEWS } from "./actions";
...
export default function reducer(state = INITIAL_STATE, { type, payload }) {
    ...
    switch (type) {
        ...
        case ACTION_DELETE_NEWS_DRAFT:
            return state.filter(el => el.id !== payload ? true : false); 
        case ACTION_EDIT_NEWS_DRAFT:
